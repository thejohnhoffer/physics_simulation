...
******************************************************************************/
#ifndef SOFA_COMPONENT_COLLISION_StimuliBarycentricPenalityContact_H
#define SOFA_COMPONENT_COLLISION_StimuliBarycentricPenalityContact_H
...
class StimuliBarycentricPenalityContact : public core::collision::Contact
{
public:
    SOFA_CLASS(SOFA_TEMPLATE3(StimuliBarycentricPenalityContact, TCollisionModel1, TCollisionModel2, ResponseDataTypes), core::collision::Contact);
...
//#else
    typedef interactionforcefield::StimuliPenalityContactForceField<ResponseDataTypes> ResponseForceField;
//#endif
protected:
    ...
    StimuliBarycentricPenalityContact(CollisionModel1* model1, CollisionModel2* model2, Intersection* intersectionMethod);
    ~StimuliBarycentricPenalityContact();
