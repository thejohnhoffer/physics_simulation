...
******************************************************************************/
#ifndef SOFA_COMPONENT_COLLISION_StimuliBarycentricPenalityContact_INL
#define SOFA_COMPONENT_COLLISION_StimuliBarycentricPenalityContact_INL

#include "StimuliBarycentricPenalityContact.h"
...
StimuliBarycentricPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::StimuliBarycentricPenalityContact(CollisionModel1* _model1, CollisionModel2* _model2, Intersection* _intersectionMethod)
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
StimuliBarycentricPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::~StimuliBarycentricPenalityContact()
{
}


template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void StimuliBarycentricPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::cleanup()
{
    if (ff!=NULL)
    {
        ff->cleanup();
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void StimuliBarycentricPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::setDetectionOutputs(OutputVector* o)
{
...
//                                  );
		...
		if(model2->getName() == "surfLine"){
			sofa::component::collision::TLine<defaulttype::Vec3dTypes> myElem2(o->elem.second);
			ff->addContact(index1, index2, myElem2.i1(), myElem2.i2(), o->normal, distance, stiffness, mu_v/* *distance */, mu_v, index);
		}
		else{
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void StimuliBarycentricPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::createResponse(core::objectmodel::BaseContext* group)
{
    if (ff!=NULL)
    {
        if (parent!=NULL)
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void StimuliBarycentricPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::removeResponse()
{
    if (ff!=NULL)
    {
        if (parent!=NULL)
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void StimuliBarycentricPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::draw(const core::visual::VisualParams* )
{
    //	if (ff!=NULL)
    //		ff->draw(vparams);
}
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void StimuliBarycentricPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::setInteractionTags(MechanicalState1* mstate1, MechanicalState2* mstate2)
{
