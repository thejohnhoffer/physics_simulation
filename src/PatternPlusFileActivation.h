...
******************************************************************************/
#ifndef SOFA_COMPONENT_MASS_PatternPlusFileActivation_H
#define SOFA_COMPONENT_MASS_PatternPlusFileActivation_H
...
class PatternPlusFileActivationInternalData
{
};
...
template <class DataTypes, class TMassType>
class PatternPlusFileActivation : public core::behavior::Mass<DataTypes>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE2(PatternPlusFileActivation,DataTypes,TMassType), SOFA_TEMPLATE(core::behavior::Mass,DataTypes));
	...
	Real m_patternConstant;
	Real m_fileConstant;
	Data<Real> f_patternConstant;
	Real m_activationPhase;
	Data<Real> f_activationPhase;
	Data<Real> f_fileConstant;
	Real m_activationPeriod;
	Data<Real> f_activationPeriod;
...
protected:
    ...
    PatternPlusFileActivation();
    ~PatternPlusFileActivation();

    /// Internal data required for Cuda computation (copy of vertex mass for deviceRead)
    PatternPlusFileActivationInternalData<DataTypes, MassType> data;
    friend class PatternPlusFileActivationInternalData<DataTypes, MassType>;
...
public:
    ...
    void setPatternPlusFileActivation(std::vector<double> values)
    {
...
protected:
    ...
    {
    public:
        VertexMassHandler(PatternPlusFileActivation<DataTypes,TMassType>* _m, PointData<helper::vector<TMassType> >* _data) : topology::TopologyDataHandler<Point,helper::vector<TMassType> >(_data), m(_m) {}
    ...
    protected:
        PatternPlusFileActivation<DataTypes,TMassType>* m;
    };
    ...
    {
    public:
        EdgeMassHandler(PatternPlusFileActivation<DataTypes,TMassType>* _m, EdgeData<helper::vector<TMassType> >* _data) : topology::TopologyDataHandler<Edge,helper::vector<TMassType> >(_data), m(_m) {}
    ...
    public:
        typedef typename DataTypes::Real Real;
        TetrahedronMassHandler(PatternPlusFileActivation<DataTypes,TMassType>* _m, TetrahedronData<helper::vector<MassVector> >* _data) : topology::TopologyDataHandler<Tetrahedron,helper::vector<MassVector> >(_data), m(_m) {}
