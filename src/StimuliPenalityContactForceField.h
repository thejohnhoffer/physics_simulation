...
******************************************************************************/
#ifndef SOFA_COMPONENT_INTERACTIONFORCEFIELD_StimuliPenalityContactForceField_H
#define SOFA_COMPONENT_INTERACTIONFORCEFIELD_StimuliPenalityContactForceField_H
...
class StimuliPenalityContactForceField : public core::behavior::PairInteractionForceField<DataTypes>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(StimuliPenalityContactForceField, DataTypes), SOFA_TEMPLATE(core::behavior::PairInteractionForceField, DataTypes));
...
//        Real mu_v;          ///< viscous friction coefficient (currently unused)
	...
	behaviormodel::StimuliMechano* m_stimuli;
    // contacts from previous frame
    sofa::helper::vector<Contact> prevContacts;
	public:

    StimuliPenalityContactForceField(MechanicalState* object1, MechanicalState* object2);

    StimuliPenalityContactForceField()
    {
    }
...
#ifndef SOFA_FLOAT
extern template class SOFA_SiElegansPlugin_API StimuliPenalityContactForceField<defaulttype::Vec3dTypes>;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_SiElegansPlugin_API StimuliPenalityContactForceField<defaulttype::Vec3fTypes>;
#endif
#endif
